...
import 'package:play_than_pay/credit.dart';

class SportBook extends StatefulWidget {
  const SportBook({Key? key}) : super(key: key);

  @override
  State<SportBook> createState() => _SportBookState();
}

class _SportBookState extends State<SportBook> {
  bool button1 = false;
  bool button2 = false;
  bool button3 = false;
  bool button4 = false;
